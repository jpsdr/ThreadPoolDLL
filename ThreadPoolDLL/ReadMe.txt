...
AppWizard a créé cette DLL ThreadPoolDLL pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application ThreadPoolDLL.


ThreadPoolDLL.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé ThreadPoolDLL.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
